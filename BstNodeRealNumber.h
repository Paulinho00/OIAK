...
extern struct BstNodeRealNumber* constructorRealNumberNode(int* pointerToIntValue, int* pointerToFractionalPart, struct BstNodeInt* parent, int* count, int isSigned);

// Znajduje wskaznik na dany element
extern struct BstNodeRealNumber *findPointerToElementRealNumber(int* pointerToIntValue, int* pointerToFractionalPart, struct BstNodeInt* root, int bytes, int isSigned);
